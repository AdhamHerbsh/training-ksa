    ...
    <main class="container align-content-center text-center h-100 w-100 m-auto">
        <div class="form-signin overlay-box py-3 px-4 m-auto shadow border border-1 border-secondary rounded-4">
            <form action="?auth=login" method="post">
                <h1 class="mb-3 fw-normal text-white" data-i18n="auth.login.title">Please Login</h1>
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="floatingInput" data-i18n="auth.login.email">Email address</label>
                </div>
                <div class="form-floating position-relative">

                    <input type="password" class="form-control" id="floatingPassword" name="password"
                        placeholder="Password" required>
                    <label for="floatingPassword" data-i18n="auth.login.password">Password</label>
                ...
                <div class="checkbox mb-3">
                    <label class="text-white">
                        <input type="checkbox" value="remember-me"> <span data-i18n="auth.login.remember-me">Remember
                            me</span>
                    </label>
                </div>

                <button class="w-100 btn btn-lg btn-primary" type="submit"
                    data-i18n="auth.login.login-button">Login</button>
                <hr>
                <a href="?auth=register" class="w-100 btn btn-lg btn-outline-secondary"
                    data-i18n="auth.login.register-button">Register</a>
                <hr>
                <div class="mb-3">
                    <label>
                        <a href="?auth=reset-password" data-i18n="auth.login.forget-password">Forget Password</a>
                    </label>
                </div>

<footer class="py-3 mt-4">
    <div class="container">
        ...
        <ul class="nav justify-content-center">
            ...
            <li class="nav-item"><a href="https://www.tiktok.com/@cluster2_riyadh?_t=ZS-8xh3WEc5cAB&_r=1"
                    class="nav-link"><i class="bi bi-tiktok"></i></a></li>
            <li class="nav-item"><a href="https://www.instagram.com/cluster2_riyadh" class="nav-link"><i
                        class="bi bi-instagram"></i></a></li>
            <li class="nav-item"><a href="https://www.snapchat.com/add/r2_riyadh" class="nav-link"><i
